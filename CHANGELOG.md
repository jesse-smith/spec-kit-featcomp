...
- Pre-flight validation: branch check and task completion check
- Status header injection into spec.md, plan.md, tasks.md
- Central `specs/STATUS.md` registry management
